...
echo -e "${CYAN}--- usr.dfl_rnd7_7e51957() $* in file://${ENV_1}/usr.dfl.prc ---${NORMAL}" #started functions

usr.dfl_rnd7_7e51957() {

    # HST :: gig command :: [ufl_stl0 1 2 ${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/014_gig_dr2m/_exa/simple.exa/_cntx.org.d.ufl_stl0_14.d/.d/.prc/usr.dfl.prc in file://${ST_RC_D_PATH}/.d/.arb/stl0.arb/ufl_stl0.ram/.grot/ufl_stl0.sh] in file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/014_gig_dr2m/_exa/simple.exa/_cntx.org.d.ufl_stl0_14.d
