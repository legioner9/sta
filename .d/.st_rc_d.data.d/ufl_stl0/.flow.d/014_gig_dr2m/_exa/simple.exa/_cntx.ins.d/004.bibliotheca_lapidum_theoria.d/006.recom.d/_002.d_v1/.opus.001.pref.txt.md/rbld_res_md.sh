...
echo -e "${CYAN}--- rbld_res_md_rnd7_ca48728() $* in file://${ST_RC_D_PATH}/.d/.opus/readme.opus/cntx.ins.d/004.bibliotheca_lapidum_theoria.d/006.recom.d/002.d/.opus.001.pref.txt.md/rbld_res_md.sh ---${NORMAL}" #started functions

rbld_res_md_rnd7_ca48728() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${ST_RC_D_PATH}/.d/.opus/readme.opus/cntx.ins.d/004.bibliotheca_lapidum_theoria.d/006.recom.d/002.d/.opus.001.pref.txt.md/rbld_res_md.sh"
