...
echo -e "${CYAN}--- usr.dfl_bfr_rnd7_388309f() $* in file://{{file_name}} ---${NORMAL}" #started functions

usr.dfl_bfr_rnd7_388309f() {

    # HST :: gig command :: [ufl_stl0 1 2 ${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/014_gig_dr2m/_tst/part_1/_dir_tst/_org.tst.d.ufl_stl0_14.d/.d/.prc/bfr.d/usr.dfl_bfr.prc in file://${ST_RC_D_PATH}/.d/.arb/stl0.arb/ufl_stl0.ram/.grot/ufl_stl0.sh] in file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/014_gig_dr2m/_tst/part_1/_dir_tst/_org.tst.d.ufl_stl0_14.d
