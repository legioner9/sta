...
echo -e "${CYAN}--- _rbld_res_md_rnd7_fbe47ee() $* in file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/013_fs4ufl9smpl/_tst/part_1/_dir_tst/name_1/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_fbe47ee() {
