...
echo -e "${CYAN}--- _tst_this_1_rnd7_a99e32c() $* in file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/009_dr2m/_tst/part_1/_tst_this_1.sh---${NORMAL}" #started functions
...
_tst_this_1_rnd7_a99e32c() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/009_dr2m/_tst/part_1/_tst_this_1.sh"
