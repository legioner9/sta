...
echo -e "${CYAN}--- file_rnd7_6cc7072() $* in file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/009_dr2m/.prc/nod2md.d/file.prc ---${NORMAL}" #started functions
...
file_rnd7_6cc7072() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/009_dr2m/.prc/nod2md.d/file.prc"
