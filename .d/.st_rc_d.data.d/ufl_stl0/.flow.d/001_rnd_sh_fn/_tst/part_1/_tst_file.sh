...
echo -e "${CYAN}--- _tst_file_rnd7_fe4ca17() $* in file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/001_rnd_sh_fn/_tst/part_1/_tst_file.sh---${NORMAL}" #started functions

_tst_file_rnd7_fe4ca17() {
