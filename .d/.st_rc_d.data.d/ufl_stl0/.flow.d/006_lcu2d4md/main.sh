...
#[[NARGS]] = {{NARGS}}
#[[PPWD]] = ${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/006_lcu2d4md/_tst/part_1
#[[res_ptv]] = file://002_ufl_flow_mm
#[[dir_ptv]] = file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d
#[[dir_res]] = file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/006_lcu2d4md
...
MAIN: cr 000.lcu.f as wrap _iac_lcu_in_d in u@dir \$2
TAGS: @
ARGS: \$1=1
EXAM: ufl_stl0 6 <u@dir>
EXEC: 
...
${NORMAL}"
    ...
    [ "${ARGS[1]}" == "_tst_1" ] && {
        ...
        _is_yes "ufl_stl0 ${ARGS[0]} _tst_1 :: . file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/006_lcu2d4md/_tst/part_1/_tst_this_1.sh" && {
            echo -e "${HLIGHT}--- . file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/006_lcu2d4md/_tst/part_1/_tst_this_1.sh ---${NORMAL}" #start files
            . ${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/ufl_stl0/.flow.d/006_lcu2d4md/_tst/part_1/_tst_this_1.sh
        }
    ...
    hint="cr 000.lcu.f as wrap _iac_lcu_in_d in u@dir \$2"
    ...
    _is_yes "cr 000.lcu.f file in ${ARGS[1]}" || {
...
_iac_lcu_in_d ${ptr_path_1}
cd ${ptr_path_1} || _st_err "${ptr_path_1} "
mv -f "__.lcu" "000.lcu.f"

echo -e "${HLIGHT}--- cat 000.lcu.f ---${NORMAL}" #start files
cat "000.lcu.f"
