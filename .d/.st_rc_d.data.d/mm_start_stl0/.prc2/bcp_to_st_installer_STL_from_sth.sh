...
echo -e "${CYAN}--- bcp_install_STL_to_sth_rnd7_48539f7() $* in file://${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/mm_start_stl0/.prc2/bcp_to_st_installer_STL_from_sth.sh ---${NORMAL}" #started functions

bcp_install_STL_to_sth_rnd7_48539f7() {
...
${NORMAL}"
    ...
    _is_yes "DO? COPY file:///home/sth/.install.sh/main_install.sh to file://${HOME}/REPOBARE/_repo/st_rc_d/.d/.install.ax/main_install_stl.sh " && {
