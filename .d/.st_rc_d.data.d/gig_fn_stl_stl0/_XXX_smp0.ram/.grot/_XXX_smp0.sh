...
filename="${ST_RC_D_PATH}/.d/.arb/smp0.arb/_XXX_smp0.ram/.grot/_XXX_smp0.sh"
...
_XXX_smp0() {
    ...
    #* local fn_data_dir=${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/_XXX_smp0

    local fn_sh_file=${ST_RC_D_PATH}/.d/.arb/smp0.arb/_XXX_smp0.ram/.grot/_XXX_smp0.sh
    local d_name=$(dirname ${ST_RC_D_PATH}/.d/.arb/smp0.arb/_XXX_smp0.ram/.grot/_XXX_smp0.sh)
...
${NORMAL}"
    ...
    # local dir_fn_data=${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/_XXX_smp0
