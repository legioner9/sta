...
_d2f_marg() {
    ...
    if [[ "-h" == "$1" ]]; then
        echo -e "
MAIN: ${FNN} :: \$1 file result (3d arg _d2f) \$2 0 or num  or '-h' (menu from st.d/.mul/_d2f_marg/x.h) flow from ${HOME}/.d/.rc.d/.st.rc.d/.st.d/.mul/_d2f_marg (1d arg _d2f: x.flow/x.insert.d, 2d arg _d2f: x.flow/x.tml )
TAGS:
\$1 
[, \$2]
CNTL: 
    ...
    _h_mm: menu from ${HOME}/.d/.rc.d/.st.rc.d/.st.d/.mul/_d2f_marg files x.h
    _E : cat from ${HOME}/.d/.rc.d/.st.rc.d/.st.d/.mul/_d2f_marg all files x.h
EXAM: 
    ${FNN}
"
        return 0
    ...
    __help_mm_d2f_marg() {
        ...
        local path_mul=${HOME}/.d/.rc.d/.st.rc.d/.st.d/.mul/_d2f_marg
        local arr=()
    ...
    if [[ "_h_mm" == "$1" ]]; then
        #! menu from ${HOME}/.d/.rc.d/.st.rc.d/.st.d/.mul/_d2f_marg files x.h
        __help_mm_d2f_marg
        return 0
    fi
    ...
    if [[ "_E" == "$1" ]]; then
        #! catalog all ${HOME}/.d/.rc.d/.st.rc.d/.st.d/.mul/_d2f_marg files x.h
        __E_mm_d2f_marg
        return 0
    fi

    if _isn_od ${ARGS1}; then
        hint="\$1 file result (3d arg _d2f) \$2 0 or num flow from ${HOME}/.d/.rc.d/.st.rc.d/.st.d/.mul/_d2f_marg (1d arg _d2f: x.flow/x.insert.d, 2d arg _d2f: x.flow/x.tml )"
