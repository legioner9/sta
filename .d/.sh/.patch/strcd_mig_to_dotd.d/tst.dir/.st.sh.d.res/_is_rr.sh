...
[, \$2]
CNTL: 
    _e : _edit body      : _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_is_rr.sh
    _t : _edit tst_dir   : _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_is_rr.tst.d
    _d : exec tst_dir_fn : . ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_is_rr.tst.d/_is_rr.tst.sh
EXAM: 
    ${FNN}
"
        return 0
    ...
    if [[ "_e" == "$1" ]]; then
        _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_is_rr.sh
        return 0
    fi

    if [[ "_t" == "$1" ]]; then
        _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_is_rr.tst.d
        return 0
    fi

    if [[ "_d" == "$1" ]]; then
        . ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_is_rr.tst.d/_is_rr.tst.sh
        return 0
    fi
